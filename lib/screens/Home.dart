  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: CupertinoTabBar(
        ...
        items: [
          BottomNavigationBarItem(icon: Icon(MdiIcons.bookshelf)),
          BottomNavigationBarItem(icon: Icon(MdiIcons.pen)),
          BottomNavigationBarItem(icon: Icon(MdiIcons.handHeartOutline)),
          BottomNavigationBarItem(icon: Icon(MdiIcons.accountCircleOutline)),
        ],
